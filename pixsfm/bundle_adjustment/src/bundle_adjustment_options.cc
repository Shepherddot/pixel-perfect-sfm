...
void BundleAdjustmentSetup::SetConstantTvec(const colmap::image_t image_id, const std::vector<int>& idxs) {
...
void BundleAdjustmentSetup::AddVariablePoint(const colmap::point3D_t point3D_id) {
  THROW_CHECK(!HasConstantPoint(point3D_id));
  colmap::BundleAdjustmentConfig::AddVariablePoint(point3D_id);
}

void BundleAdjustmentSetup::AddConstantPoint(const colmap::point3D_t point3D_id) {
