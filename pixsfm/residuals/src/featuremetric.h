...
struct FeatureMetricCostFunctor {
  ...
  static ceres::CostFunction* Create(
    ...
    return (
        new ceres::
            AutoDiffCostFunction<FeatureMetricCostFunctor, N_NODES * CHANNELS, 4, 3, 4, 3, 3, CameraModel::num_params, SourceCameraModel::num_params>(
  ...
  static ceres::CostFunction* Create(const FeaturePatch<dtype>& target_patch,
    ...
    return (
        new ceres::
            AutoDiffCostFunction<FeatureMetricCostFunctor, N_NODES * CHANNELS, 4, 3, 4, 3, 3, CameraModel::num_params, SourceCameraModel::num_params>(
                new FeatureMetricCostFunctor(target_patch, NULL, interpolation_config, reference_descriptor)));
  }
...
struct FeatureMetricSharedIntrinsicsCostFunctor
  ...
  static ceres::CostFunction* Create(InterpolationConfig& interpolation_config,
                                     ...
                                     const double* reference_descriptor) {
    return (new ceres::AutoDiffCostFunction<FeatureMetricSharedIntrinsicsCostFunctor, N_NODES * CHANNELS, 4, 3, 4, 3, 3, CameraModel::num_params>(
        new FeatureMetricSharedIntrinsicsCostFunctor(target_patch, NULL, interpolation_config, reference_descriptor)));
  }
